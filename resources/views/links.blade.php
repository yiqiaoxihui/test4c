  ...
  <script>
    ...
    */
    function clickCell(e, field, value, row, $element){
      ...
      var fields = $element.parent().children();
      $table.bootstrapTable('expandRow', index );
    }
    function detailFormatter(index, row) {
      var html = [];
      var d_content = new Object();
      d_content['as1'] = row['as1']
      d_content['as2'] = row['as2']
      d_content['message'] = row['message']
      $.ajax({
        async: false,
        data:{type: 'detail', field:d_content},
        success: function(data){
          html.push('<p style="word-wrap:break-word; word-break:break-all; width:auto;"><b>' + 'AS1' + ':</b> ' + data.as1.result.Name + '</p>');
          html.push('<p style="word-wrap:break-word; word-break:break-all; width:auto;"><b>' + 'AS2' + ':</b> ' + data.as2.result.Name + '</p>');
